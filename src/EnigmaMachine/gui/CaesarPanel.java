...
public class CaesarPanel extends JPanel{
    ...
    */
    private void decrypt(){
        if(checkKey()){
            if(checkInput()){
                String answer = EnigmaMachine.decryptCaesar(input.getText(), Integer.parseInt(key.getText()));
    ...
    */
    private void encrypt(){
        if(checkKey()){
            if(checkInput()){
                String answer = EnigmaMachine.encryptCaesar(input.getText(), Integer.parseInt(key.getText()));
                output.setText(answer);
            }
            else{
