 ...
 */
public class ColumnarTranspositionPanel extends JPanel{
    ...
    public ColumnarTranspositionPanel(ViewManager view){
        viewManager = view;
    ...
    /**
     * Method to make all the object displayed on the panel
     */
    private void makeObjects(){
        
        // creating the cipherName or title of the panel
        cipherName = new JLabel("Columnar Transposition Cipher");
        ...
        cipherIntro = new JLabel("<html>.<br> "
                + "<html>");
    ...
    /**
     * method to add the objects to the panel in order
     */
    ...
    private void decrypt(){
        if(checkKey()){
            if(checkInput()){
                String answer = EnigmaMachine.decryptColumnarTransposition(input.getText(), key.getText());
                output.setText(answer);
            }
            else{
                Dialogs.error(viewManager, "The text you have entered is invalid, ensure it only contains the English alphabet or numbers", "Invalid Text");
            }
        }
        else{
    ...
    private void encrypt(){
        if(checkKey()){
            if(checkInput()){
                String answer = EnigmaMachine.encryptColumnarTransposition(input.getText(), key.getText());
                output.setText(answer);
            }
            else{
                Dialogs.error(viewManager, "The text you have entered is invalid, ensure it contains only the English alphabet or numbers", "Invalid Text");
            }
        }
        else{
            Dialogs.error(viewManager, "The key you have entered is invalid, ensure it contains only the English alphabet", "Invalid Key");
    ...
    /**
     * Method to check if the characters in the key are correct
     * @return will return true if correct and false otherwise
     */
    ...
    /**
     * Method to check if the character in the input are correct
     * @return will return true if correct and false otherwise
     */
