 ...
 */
public class RailFencePanel extends JPanel{
    ...
    public RailFencePanel(ViewManager view){
        viewManager = view;
    ...
    private void makeObjects(){
        ...
        cipherName = new JLabel("RailFence Cipher");
    ...
    */
    private void decrypt(){
        if(checkKey()){
            if(checkInput()){
                String answer = EnigmaMachine.decryptRailFence(input.getText(), Integer.parseInt(key.getText()));
    ...
    */
    private void encrypt(){
        if(checkKey()){
            if(checkInput()){
                String answer = EnigmaMachine.encryptRailFence(input.getText(), Integer.parseInt(key.getText()));
                output.setText(answer);
            }
            else{
