 ...
 */
public class ADFGVXPanel extends JPanel{
    ...
    public ADFGVXPanel(ViewManager view){
        viewManager = view;
    ...
    private void makeObjects(){
        ...
        cipherName = new JLabel("ADFGVX Cipher");
        ...
        cipherIntro = new JLabel("<html>Assume each letter in the alphabet is numbered from 0-25.<br> "
                + "The Vigenere cipher is an polyalphabetic substitution cipher which uses interwoven Caeser ciphers to resists attacks. It requires one text key to encrypt and decrypt.<br>"
                + "The key is converted to numbers and then the letters in the plaintext are encrypted by using multiple Caesar ciphers one for each letter in the key.<html>");
    ...
    */
    private void decrypt(){
        if(checkKey()){
            if(checkInput()){
                String answer = EnigmaMachine.decryptADFGVX(input.getText(), key.getText());
    ...
    */
    private void encrypt(){
        if(checkKey()){
            if(checkInput()){
                String answer = EnigmaMachine.encryptADFGVX(input.getText(), key.getText());
                output.setText(answer);
            }
            else{
